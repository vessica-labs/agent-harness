...
# Apple Silicon macOS
curl -fL https://github.com/vessica-labs/agent-harness/releases/download/v0.1.0-rc.8/agent-harness-darwin-arm64 \
...
agent-harness railway init \
  ...
  --checkpoint agent-harness-worker-0.1.0-rc.8
