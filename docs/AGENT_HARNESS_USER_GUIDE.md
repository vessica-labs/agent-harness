...
> **Release status:** Agent Harness is currently a release candidate. These instructions were verified against `v0.1.0-rc.25`. Jira integration is coming soon and is not part of the supported workflow documented here.
...
curl -fL \
  https://github.com/vessica-labs/agent-harness/releases/download/v0.1.0-rc.25/agent-harness-darwin-arm64 \
...
Release assets are published for macOS and Linux on AMD64 and ARM64. This example installs `v0.1.0-rc.25` on Apple Silicon macOS:
